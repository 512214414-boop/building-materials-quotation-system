...
export const menuConfig: MainModuleDef[] = [
  ...
  },
  {
    ...
    label: '进货管货',
    navPath: '进货管货',
    homePath: '/staff/operation/purchase-inbound',
    requireViews: ['inventory'],
    children: [
      {
        ...
        label: '采购入库',
        navPath: '进货管货.采购入库',
        path: '/staff/operation/purchase-inbound',
        requireViews: ['inventory'],
        component: lazy(() => import('./pages/PurchaseInbound.js')),
      },
      {
        key: 'inbound-tasks',
        label: '待入库管理',
  ...
  },
  {
    ...
    label: '配货运营',
    navPath: '配货运营',
    homePath: '/staff/basic/backorders',
    requireViews: ['inventory'],
    children: [
      {
        key: 'backorders',
    ...
    children: [
      {
        ...
        path: '/staff/ops',
        requireViews: ['ops_report'],
        component: lazy(() => import('./pages/OpsReports.js')),
      },
    ],
  },
  {
