...
export const REGISTRY_GENERATED: RegistryDef[] = [
  ...
  { model: "product_name", label: "产品名", uniqueKey: { type: 'global' }, defaults: () => ({"sortOrder":0,"status":1}) },
];
...
export const RESOURCES: Record<string, {
  ...
  product_name: { key: "product_name", label: "产品名档案", table: "product_name", model: "product_name", primaryKey: "id", primaryKeyType: "int", permission: "product_manage", softDelete: {"field":"status","off":0}, writable: ["name","sortOrder","status"], include: [], audit: [], refTargets: [{"label":"产品","table":"product","field":"productNameId"}], readOnly: undefined, search: {"fields":["name"],"mode":"normalized","dictUnique":"global"} },
