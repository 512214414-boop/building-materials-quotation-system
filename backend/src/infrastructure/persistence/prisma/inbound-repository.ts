// 机器生成（tools/gen-repositories.mjs）· 基础设施层 · inbound 上下文仓储
//
...
export const inboundRepository = {
  inbound_tasks: prisma.inbound_tasks,
  inbound_lines: prisma.inbound_lines,
  purchase_inbounds: prisma.purchase_inbounds,
  purchase_inbound_lines: prisma.purchase_inbound_lines,
};
