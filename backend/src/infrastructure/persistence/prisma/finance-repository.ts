// 机器生成（tools/gen-repositories.mjs）· 基础设施层 · finance 上下文仓储
//
...
export const financeRepository = {
  reimbursement_bills: prisma.reimbursement_bills,
  reimbursement_bill_lines: prisma.reimbursement_bill_lines,
};
